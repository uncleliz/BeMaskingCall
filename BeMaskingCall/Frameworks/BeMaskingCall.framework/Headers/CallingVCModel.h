...
@interface CallingVCModel : NSObject
@property NSString *strImgBackground;
@property NSString *strImgSpeakerOff;
@property NSString *strImgSpeakerOn;
@property NSString *strImgMuteOff;
@property NSString *strImgMuteOn;
@property NSString *strImgAccept;
@property NSString *strImgDecline;
@property NSString *strColorBackground;
@property NSString *strColorText;
